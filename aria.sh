...
aria2c --allow-overwrite=true --auto-file-renaming=true --bt-enable-lpd=true --bt-detach-seed-only=false \
       ...
       --summary-interval=0 --max-upload-limit=1K --max-overall-upload-limit=1K
